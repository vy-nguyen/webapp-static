...
!function (a) {
    "function" == typeof define && define.amd ? define(["jquery", "../../../../bower_components/moment/moment"], a) : a(jQuery, moment)
}(function (a, b) {
    function c(a, b) {
    ...
    function S(a, b, c, d, e) {
        return a = Eb.moment.parseZone(a), b = Eb.moment.parseZone(b), c = a.localeData().longDateFormat(c) || c, d = d || " - ", T(a, b, V(c), d, e)
    }
    ...
    function X(a, b) {
        ...
        function d(a) {
            e.intervalStart = a.clone().stripTime().startOf("month"), e.intervalEnd = e.intervalStart.clone().add( 1, "months"), e.start = e.intervalStart.clone(), e.start = e.skipHiddenDays(e.start), e.start.startOf("week"), e.start = e.skipHiddenDays(e.start), e.end = e.intervalEnd.clone(), e.end = e.skipHiddenDays(e.end, -1, !0), e.end.add((7 - e.end.weekday()) % 7, 'days'), e.end = e.skipHiddenDays(e.end, -1, !0);
            var c = Math.ceil(e.end.diff(e.start, "weeks", !0));
            "fixed" == e.opt("weekMode") && (e.end.add( 6 - c, "weeks"), c = 6), e.title = b.formatDate(e.intervalStart, e.opt("titleFormat")), e.renderBasic(c, e.getCellsPerWeek(), !0)
        }
    ...
    function Y(a, b) {
        ...
        function d(a) {
            e.intervalStart = a.clone().stripTime().startOf("week"), e.intervalEnd = e.intervalStart.clone().add( 1, "weeks"), e.start = e.skipHiddenDays(e.intervalStart), e.end = e.skipHiddenDays(e.intervalEnd, -1, !0), e.title = b.formatRange(e.start, e.end.clone().subtract(1), e.opt("titleFormat"), " \u2014 "), e.renderBasic(1, e.getCellsPerWeek(), !1)
        }
    ...
    function Z(a, b) {
        ...
        function d(a) {
            e.start = e.intervalStart = a.clone().stripTime(), e.end = e.intervalEnd = e.start.clone().add( 1, "days"), e.title = b.formatDate(e.start, e.opt("titleFormat")), e.renderBasic(1, 1, !1)
        }
    ...
    function $(b, c, d) {
        ...
        function t(a) {
            return a.clone().stripTime().add( 1, "days")
        }
    ...
    function ab(a, b) {
        ...
        function d(a) {
            e.intervalStart = a.clone().stripTime().startOf("week"), e.intervalEnd = e.intervalStart.clone().add( 1, "weeks"), e.start = e.skipHiddenDays(e.intervalStart), e.end = e.skipHiddenDays(e.intervalEnd, -1, !0), e.title = b.formatRange(e.start, e.end.clone().subtract(1), e.opt("titleFormat"), " \u2014 "), e.renderAgenda(e.getCellsPerWeek())
        }
    ...
    function bb(a, b) {
        ...
        function d(a) {
            e.start = e.intervalStart = a.clone().stripTime(), e.end = e.intervalEnd = e.start.clone().add( 1, "days"), e.title = b.formatDate(e.start, e.opt("titleFormat")), e.renderAgenda(1)
        }
    ...
    function eb(c, d, e) {
        ...
        function y(a, b) {
            ...
            for (var c = 0; Bb > c; c++) {
                var d = Vb(0, c), e = d.clone().add( 1, "days"), f = a > d ? a : d, g = b > e ? e : b;
                if (g > f) {
        ...
        function L(a) {
            return a.hasTime() ? a.clone().add(rb) : a.clone().add( 1, "days")
        }
            ...
            c.draggable({
                ...
                "start": function (b, d) {
                    o("eventDragStart", c[0], a, b, d), Q(a, c), f = c.width(), k.start(function (b, d) {
                        if (U(), b) {
                            ...
                            h = k.diff(f, "days"), b.row ? i ? j && (c.width(l - 10), r(c, Y.defaultTimedEventDuration / p * q), c.draggable("option", "grid", [l, 1]), j = !1) : g = !0 : (T(a.start.clone().add( h, "days"), $(a).add( h, "days")), e()), g = g || j && !h
                        } else e(), g = !0;
                ...
                "stop": function (d, f) {
                    if (k.stop(), U(), o("eventDragStop", c[0], a, d, f), g)e(), c.css("filter", ""), P(a, c); else {
                        var i, l, n = a.start.clone().add( h, "days");
        ...
        function k(a, b, c) {
            ...
            b.draggable({
                ...
                "drag": function (c, e) {
                    ...
                    (h != i || j != k || l != p || r != s) && (j ? (t = a.start.clone().stripTime().add( q, "days"), u = t.clone().add(Y.defaultAllDayEventDuration)) : (t = a.start.clone().add(r * z).add( q, "days"), u = $(a).add(r * z).add( q, "days")), d(), i = h, k = j, p = l, s = r), b.draggable("option", "revert", !h)
                },
                "stop": function (c, e) {
    ...
    function qb(c, d, e) {
        ...
        function v(a, b, c) {
            var d = a.clone();
            for (b = b || 1; P[(d.day() + (c ? b : 0) + 7) % 7];)d.add( b, "days");
            return d
        }
        ...
        function z(a) {
            return G.start.clone().add( a, "days")
        }
                ...
                "start": function (f, g) {
                    y("eventDragStart", b[0], a, f, g), H(a, b), e.start(function (e, f, g, h) {
                        if (b.draggable("option", "revert", !e || !g && !h), U(), e) {
                            var i = Y(f), j = Y(e);
                            c = j.diff(i, "days"), d = a.start.clone().add( c, "days"), T(d, cb(a).add( c, "days"))
                        } else c = 0
                    }, f, "drag")
                },
                "stop": function (f, g) {
            ...
            G(d), d.mousedown(function (a) {
                ...
                if (1 == f.which) {
                    ...
                    V(), a("body").css("cursor", g + "-resize").one("mouseup", h), y("eventResizeStart", d[0], b, f, {}), m.start(function (d, f) {
                        if (d) {
                            var h = Z(f), i = Z(d);
                            if (i = Math.max(i, p), j = $(i) - $(h), k = cb(b).add( j, "days"), j) {
                                o.end = k;
                                var m = l;
        ...
        function f(b) {
            ...
            if (1 == b.which && j("selectable")) {
                ...
                g.start(function (a, b) {
                    n(), a && f(a) ? (k = [c(b), c(a)].sort(B), m(k[0], k[1].clone().add( 1, "days"))) : k = null
                }, b), a(document).one("mouseup", function (a) {
                    g.stop(), k && (+k[0] == +k[1] && i(k[0], a), e(k[0], k[1].clone().add( 1, "days"), a))
                })
            }
        }
